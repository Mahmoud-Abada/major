...
export function WeeklyCalendar({ entries, onEntryClick, onEntryEdit }: WeeklyCalendarProps) {
            ...
            <div className="border rounded-lg overflow-hidden">
                ...
                <div className="grid grid-cols-7 bg-muted/50">
                    ...
                    {daysOfWeek.map((day, index) => (
                        <div key={day.key} className="p-3 border-r last:border-r-0 text-center">
                ...
                <div className="grid grid-cols-7 min-h-[600px]">
                    ...
                    <div className="border-r bg-muted/20">
                        {timeSlots.filter((_, index) => index % 2 === 0).map((time) => (
                            <div key={time} className="h-20 border-b flex items-center justify-center text-xs text-muted-foreground">
                                {time}
                            </div>
                        ))}
                    </div>
                    ...
                    {weekDates.map((date, dayIndex) => (
                        <div key={dayIndex} className="border-r last:border-r-0 relative">
                            {/* Time Slot Grid */}
                            {timeSlots.filter((_, index) => index % 2 === 0).map((time, slotIndex) => (
