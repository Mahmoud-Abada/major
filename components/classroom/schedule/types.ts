...
export interface ScheduleConflict {
    id: string;
    type: "time_overlap" | "room_conflict" | "teacher_conflict" | "class_conflict";
...
export interface Room {
    id: string;
    name: string;
    type: "classroom" | "laboratory" | "auditorium" | "library" | "gym" | "office";
    capacity: number;
    equipment: string[];
    location: string;
    isAvailable: boolean;
...
export interface UpdateScheduleEntryRequest extends Partial<CreateScheduleEntryRequest> {
    id: string;
    status?: "scheduled" | "ongoing" | "completed" | "cancelled" | "postponed";
}
