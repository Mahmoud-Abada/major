...
export function PaymentDetailsDialog({
  ...
  const isClassOverview =
    "totalStudents" in data && "paymentDistribution" in data;
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {isStudentSummary &&
              `Résumé - ${(data as StudentPaymentSummary).studentName}`}
            {isClassOverview &&
              `Classe - ${(data as ClassPaymentOverview).className}`}
          </DialogTitle>
          <DialogDescription>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-lg font-bold text-orange-600 mt-1">
                        {formatCurrency(
                          (data as Payment).remainingAmount ||
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Badge
                        variant={
                          (data as Payment).status === "paid"
                            ? "default"
                            : (data as Payment).status === "partial"
                              ? "secondary"
                              : (data as Payment).status === "overdue"
                                ? "destructive"
                                : (data as Payment).status === "cancelled"
                                  ? "outline"
                                  : "secondary"
                        }
                        className="mt-1"
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm font-medium mt-1">
                        {(data as StudentPaymentSummary).studentName}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="text-sm font-medium mt-1">
                        {(data as StudentPaymentSummary).className}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-4 gap-4 text-center">
                    <div className="p-3 bg-muted/50 rounded-lg">
                      <p className="text-lg font-bold">
                        {formatCurrency(
                          (data as StudentPaymentSummary).totalDue,
                        )}
                      </p>
                    ...
                    <div className="p-3 bg-green-50 rounded-lg">
                      <p className="text-lg font-bold text-green-600">
                        {formatCurrency(
                          (data as StudentPaymentSummary).totalPaid,
                        )}
                      </p>
                    ...
                    <div className="p-3 bg-blue-50 rounded-lg">
                      <p className="text-lg font-bold text-blue-600">
                        {formatCurrency(
                          (data as StudentPaymentSummary).totalPending,
                        )}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        En Attente
                    ...
                    <div className="p-3 bg-red-50 rounded-lg">
                      <p className="text-lg font-bold text-red-600">
                        {formatCurrency(
                          (data as StudentPaymentSummary).totalOverdue,
                        )}
                      </p>
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      ...
                      <span className="font-medium">
                        {(data as StudentPaymentSummary).collectionRate.toFixed(
                          1,
                        )}
                        %
                      </span>
                    ...
                    <Progress
                      value={(data as StudentPaymentSummary).collectionRate}
                      className="h-2"
                    />
                  </div>
                </CardContent>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {(data as StudentPaymentSummary).upcomingPayments
                        .slice(0, 3)
                        .map((payment) => (
                          <div
                            key={payment.id}
                ...
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-sm font-medium mt-1">
                        {(data as ClassPaymentOverview).className}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-muted-foreground">
                      ...
                      <p className="text-lg font-bold mt-1">
                        {(data as ClassPaymentOverview).totalStudents}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-4 gap-4 text-center">
                    <div className="p-3 bg-muted/50 rounded-lg">
                      <p className="text-lg font-bold">
                        {formatCurrency(
                          (data as ClassPaymentOverview).totalDue,
                        )}
                      </p>
                      <p className="text-xs text-muted-foreground">Total Dû</p>
                    </div>
                    <div className="p-3 bg-green-50 rounded-lg">
                      <p className="text-lg font-bold text-green-600">
                        {formatCurrency(
                          (data as ClassPaymentOverview).totalPaid,
                        )}
                      </p>
                    ...
                    <div className="p-3 bg-blue-50 rounded-lg">
                      <p className="text-lg font-bold text-blue-600">
                        {formatCurrency(
                          (data as ClassPaymentOverview).totalPending,
                        )}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        En Attente
                    ...
                    <div className="p-3 bg-red-50 rounded-lg">
                      <p className="text-lg font-bold text-red-600">
                        {formatCurrency(
                          (data as ClassPaymentOverview).totalOverdue,
                        )}
                      </p>
                      <p className="text-xs text-muted-foreground">En Retard</p>
                    </div>
                  ...
                  <div>
                    <div className="flex justify-between text-sm mb-2">
                      <span>Taux de Recouvrement</span>
                      <span className="font-medium">
                        {(data as ClassPaymentOverview).collectionRate.toFixed(
                          1,
                        )}
                        %
                      </span>
                    ...
                    <Progress
                      value={(data as ClassPaymentOverview).collectionRate}
                      className="h-2"
                    />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div>
                      <p className="text-lg font-bold">
                        {(data as ClassPaymentOverview).studentsWithOverdue}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Étudiants en Retard
                      </p>
                    ...
                    <div>
                      <p className="text-lg font-bold">
                        {(
                          data as ClassPaymentOverview
                        ).averagePaymentDelay.toFixed(1)}{" "}
                        jours
                      </p>
                      <p className="text-xs text-muted-foreground">
                        Retard Moyen
