...
export function AllPostsView() {
  ...
  const filteredPosts = posts.filter((post) => {
    ...
    const matchesPriority =
      !filter.priority || post.priority === filter.priority;
              ...
              <div className="p-2 space-y-2">
                <Select
                  ...
                  onValueChange={(value) =>
                    setFilter((prev) => ({
                      ...prev,
                      type: (value as Post["type"]) || undefined,
                    }))
                  }
                >
                  <SelectTrigger>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFilter((prev) => ({
                      ...prev,
                      status: (value as Post["status"]) || undefined,
                    }))
                  }
                >
                  <SelectTrigger>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFilter((prev) => ({
                      ...prev,
                      priority: (value as Post["priority"]) || undefined,
                    }))
                  }
                >
                  <SelectTrigger>
