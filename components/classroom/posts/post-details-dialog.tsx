...
export function PostDetailsDialog({ open, onOpenChange, post }: PostDetailsDialogProps) {
    ...
    const [isLiked, setIsLiked] = useState(post?.interactions.userInteraction?.liked || false);
    const [isBookmarked, setIsBookmarked] = useState(post?.interactions.userInteraction?.bookmarked || false);
            ...
            if (comment.id === commentId) {
                ...
                return {
                    ...
                    interactions: {
                        ...
                        likes: wasLiked ? comment.interactions.likes - 1 : comment.interactions.likes + 1,
                        userInteraction: {
                        ...
                        {post.dueDate && (
                            <div className="flex items-center gap-2 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                                ...
                                <span className="text-sm font-medium text-orange-800">
                                    Échéance: {new Date(post.dueDate).toLocaleDateString('fr-FR', {
                                        weekday: 'long',
                                        year: 'numeric',
                                        month: 'long',
                                        day: 'numeric',
                                        ...
                                        <div key={attachment.id} className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
                                            <div className="flex items-center gap-3">
                                                <div className="p-2 bg-white rounded">
                                                    {attachment.type === "image" && <RiFileTextLine className="h-4 w-4 text-blue-500" />}
                                                    {attachment.type === "document" && <RiFileTextLine className="h-4 w-4 text-red-500" />}
                                                    {attachment.type === "video" && <RiFileTextLine className="h-4 w-4 text-purple-500" />}
                                                    {attachment.type === "audio" && <RiFileTextLine className="h-4 w-4 text-green-500" />}
                                                    {attachment.type === "link" && <RiFileTextLine className="h-4 w-4 text-orange-500" />}
                                                </div>
                                                <div>
                    ...
                    <div className="flex items-center justify-between p-4 bg-muted/30 rounded-lg">
                        ...
                        <div className="flex items-center gap-2">
                            <Button
                                ...
                                onClick={handleLike}
                            >
                                {isLiked ? <RiHeartFill className="h-4 w-4 mr-1" /> : <RiHeartLine className="h-4 w-4 mr-1" />}
                                J'aime
                            </Button>
                            ...
                            >
                                {isBookmarked ? <RiBookmarkFill className="h-4 w-4 mr-1" /> : <RiBookmarkLine className="h-4 w-4 mr-1" />}
                                Sauvegarder
                            </Button>
                                        ...
                                        <div className="flex-1 min-w-0">
                                            ...
                                            <div className="flex items-center gap-4">
                                                <Button
                                                    ...
                                                    className={comment.interactions.userInteraction?.liked ? "text-blue-600" : ""}
                                                >
                                    ...
                                    {comment.replies && comment.replies.length > 0 && (
                                        <div className="ml-12 space-y-3">
                                            {comment.replies.map((reply) => (
                                                <div key={reply.id} className="flex items-start gap-3 p-3 bg-muted/10 rounded-lg">
