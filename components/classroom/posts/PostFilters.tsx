        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) =>
                updateFilter("classroomId", value || undefined)
              }
            >
              <SelectTrigger>
              ...
              <div className="flex items-center justify-between pt-6">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateFilter("isPinned", checked || undefined)
                  }
                />
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {filters.type && (
                <Badge variant="outline">
                  Type:{" "}
                  {POST_TYPES.find((t) => t.value === filters.type)?.label}
                </Badge>
              )}
              {filters.author && (
                <Badge variant="outline">
                  Author:{" "}
                  {MOCK_AUTHORS.find((a) => a.value === filters.author)?.label}
                </Badge>
              )}
              {filters.classroomId && (
                <Badge variant="outline">
                  Classroom:{" "}
                  {
                    MOCK_CLASSROOMS.find((c) => c.value === filters.classroomId)
                      ?.label
                  }
                </Badge>
              )}
              ...
              {filters.isPinned && <Badge variant="outline">Pinned</Badge>}
              {filters.dateRange && (
                <Badge variant="outline">
                  Date Range:{" "}
