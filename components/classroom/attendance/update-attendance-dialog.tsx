            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                {formData.status === "present" && (
                  <p>
                    Student was present for the entire session. Please record
                    accurate time in/out if available.
                  </p>
                )}
                {formData.status === "absent" && (
                  <p>
                    Student was absent from the session. Consider adding a note
                    about the reason if known.
                  </p>
                )}
                {formData.status === "late" && (
                  <p>
                    Student arrived late. Please record the actual arrival time
                    and any relevant notes.
                  </p>
                )}
                {formData.status === "excused" && (
                  <p>
                    Student had an excused absence. Please provide details about
                    the excuse (medical, family, etc.).
                  </p>
                )}
              </div>
            </div>
