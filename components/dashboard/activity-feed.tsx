      ...
      return [
        {
          ...
          description:
            "Yacine Cherif has registered as a Computer Science teacher",
        ...
        },
        {
          ...
          description:
            "Scheduled maintenance completed successfully. All services operational",
        ...
        },
        {
          ...
          description:
            "Monthly grade reports have been generated for all active classrooms",
        ...
        },
        {
          ...
          description:
            "15 new student accounts have been verified and activated",
    ...
    case "teacher":
      return [
        ...
        },
        {
          ...
          title: "New Message",
          description:
            "Mohammed Boumediene sent you a message about his daughter's progress",
        ...
        },
        {
          ...
          description:
            "Midterm exam grades have been published for Advanced Algebra",
      ...
      return [
        {
          ...
          description:
            "Your Advanced Algebra midterm exam has been graded: 17/20",
        ...
        },
        {
          ...
          description:
            "Karim Mansouri sent feedback on your recent performance",
        ...
        },
        {
          ...
          description:
            "Your attendance has been recorded for today's Physics class",
          timestamp: new Date(now.getTime() - 6 * 60 * 60 * 1000), // 6 hours ago
          metadata: {
            status: "success",
            classroom: "Physics",
    ...
    case "parent":
      return [
        ...
        },
        {
          ...
          description:
            "Karim Mansouri sent an update about upcoming parent-teacher conference",
          timestamp: new Date(now.getTime() - 8 * 60 * 60 * 1000), // 8 hours ago
          user: {
            name: "Karim Mansouri",
            avatar: "/avatars/karim-mansouri.jpg",
        ...
        },
        {
          ...
          description:
            "Rania has a polynomial functions assignment due tomorrow",
          timestamp: new Date(now.getTime() - 12 * 60 * 60 * 1000), // 12 hours ago
          metadata: {
            status: "warning",
            classroom: "Advanced Algebra",
            ...
            {activities.map((activity, index) => {
              ...
              return (
                <motion.div
                  ...
                  onClick={() =>
                    activity.actionUrl &&
                    window.open(activity.actionUrl, "_self")
                  }
                >
                  {/* Icon */}
                  <div
                    className={`p-2 rounded-full ${statusColor} flex-shrink-0`}
                  >
