/**
 * Droppable Classroom Component for Students Drag & Drop
 */
...
import { BookOpen, MapPin, Plus, UserPlus, Users, X } from "lucide-react";

interface DroppableClassroomForStudentsProps {
    classroom: {
        _id: string;
        title: string;
        field: string;
...
export function DroppableClassroomForStudents({ classroom, assignedStudents, onRemoveStudent }: DroppableClassroomForStudentsProps) {
