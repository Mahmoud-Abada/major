...
export const algerianWilayas = [
    ...
    "بسكرة", "تبسة", "جيجل", "سيدي بلعباس", "بشار", "المسيلة", "المدية",
    "برج بوعريريج", "البويرة", "تمنراست", "الطارف", "تندوف", "تيسمسيلت",
    "الوادي", "خنشلة", "سوق أهراس", "تيبازة", "ميلة", "عين الدفلى", "النعامة",
    "عين تموشنت", "غليزان", "غرداية", "الجلفة", "قالمة", "سكيكدة", "أم البواقي",
    "معسكر", "أولاد جلال", "البيض", "إليزي", "برج باجي مختار", "تين دوف",
    "أولاد جلال", "المغير", "منيعة"
];
