...
const getApiConfig = (): ApiConfig => {
    ...
    return {
        ...
        endpoints: {
            ...
            classroom: process.env.NEXT_PUBLIC_CLASSROOM_API_URL || 'http://127.0.0.1:3001/classroom',
            notifications: process.env.NEXT_PUBLIC_NOTIFICATIONS_API_URL || `${baseUrl}/notifications`,
            files: process.env.NEXT_PUBLIC_FILES_API_URL || `${baseUrl}/files`,
            analytics: process.env.NEXT_PUBLIC_ANALYTICS_API_URL || `${baseUrl}/analytics`,
        },
