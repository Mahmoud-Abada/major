...
import { useMarkOperations, useMarksManager, useMarkStatistics } from '@/hooks/useMarks';
...
const MARK_TYPES = [
    ...
    { value: 'participation', label: 'Participation', color: 'bg-purple-100 text-purple-800' }
];

const SUBJECTS = [
    'Mathematics', 'Physics', 'Chemistry', 'Biology', 'French',
    'Arabic', 'English', 'History', 'Geography', 'Philosophy',
    'Computer Science', 'Languages', 'Literature'
];
...
export default function MarksPage() {
    ...
    const filteredMarks = marks.filter(mark => {
        const matchesSearch = mark.subject.toLowerCase().includes(searchQuery.toLowerCase()) ||
        ...
        <div className="container mx-auto py-6 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <Button onClick={() => window.location.href = '/classroom/marks/create'}>
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <div className="flex items-center gap-1 mt-1">
                                        ...
                                        <span className={`text-xs font-medium ${stats.recentTrend === 'up' ? 'text-green-600' :
                        ...
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold">{stats.passingRate.toFixed(1)}%</p>
                                </div>
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
                <TabsList>
                    ...
                    <TabsTrigger value="marks">All Marks ({filteredMarks.length})</TabsTrigger>
                ...
                <TabsContent value="overview" className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                        ...
                                        return (
                                            <div key={type} className="flex items-center justify-between">
                                                ...
                                                <div className="text-right">
                                                    <p className="font-medium">{data.average.toFixed(1)}%</p>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="space-y-4">
                                    {Object.entries(stats.bySubject).slice(0, 5).map(([subject, data]) => (
                        ...
                        <CardContent>
                            <div className="space-y-4">
                                {filteredMarks
                                    ...
                                    .slice(0, 5)
                                    .map((mark) => {
                                        const percentage = calculatePercentage(mark.value, mark.maxValue);
