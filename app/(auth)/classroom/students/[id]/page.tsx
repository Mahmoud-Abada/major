...
import { selectStudentById, updateStudent } from "@/store/slices/classroom/studentsSlice";
...
export default function StudentDetailPage() {
    ...
    const student = useSelector((state: any) => selectStudentById(state, studentId));
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground">رقم الطالب: {student.studentId}</p>
                    </div>
                </div>
                        ...
                        <div className="flex-1 space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                                    ...
                                    <span>{student.wilaya}, {student.commune}</span>
                                </div>
                                <div className="flex items-center space-x-2 text-sm text-muted-foreground">
                                    <Calendar className="h-4 w-4" />
                                    <span>انضم في {format(new Date(student.enrollmentDate), "dd/MM/yyyy")}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium">الأداء الأكاديمي</CardTitle>
                            ...
                            <CardContent>
                                <div className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <Progress
                                            value={parseInt(student.attendance?.replace('%', '') || '0')}
                                            className="h-2"
                                        />
                                    </div>
                                </div>
                            ...
                            <CardContent>
                                <div className="space-y-3">
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="font-medium">{student.totalFees.toLocaleString()} دج</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                        <span>المدفوع</span>
                                        <span className="font-medium text-green-600">{student.paidAmount.toLocaleString()} دج</span>
                                    </div>
                                    <div className="flex justify-between text-sm">
                                        <span>المتبقي</span>
                                        <span className="font-medium text-red-600">{student.pendingAmount.toLocaleString()} دج</span>
                                    </div>
                                    <Progress
                        ...
                        <Card>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                <CardTitle className="text-sm font-medium">الفصول المسجل بها</CardTitle>
                                <BookOpen className="h-4 w-4 text-muted-foreground" />
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-2">
                                    <div className="text-2xl font-bold">{student.classIds.length}</div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="text-sm font-medium text-muted-foreground">المستوى الدراسي</label>
                                        <p className="text-sm">{student.grade}</p>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium text-muted-foreground">الفصل</label>
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm">{format(new Date(student.enrollmentDate), "dd/MM/yyyy")}</p>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium text-muted-foreground">المعدل العام</label>
                                        <p className="text-sm">{student.gpa}</p>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium text-muted-foreground">نسبة الحضور</label>
                        ...
                        <Card>
                            ...
                            <CardContent>
                                <div className="space-y-3">
                                    <div>
                                        <label className="text-sm font-medium text-muted-foreground">عدد الفصول</label>
                                        <p className="text-sm">{student.classIds.length} فصل</p>
                                    </div>
                                    <div>
                                        <label className="text-sm font-medium text-muted-foreground">عدد الأساتذة</label>
                        ...
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="text-sm">{format(new Date(student.dateOfBirth), "dd/MM/yyyy")}</p>
                                </div>
                                <div>
