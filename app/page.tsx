      ...
      >
        ...
        >
          <Card className="p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-2">{t('classroomManagement')}</h3>
            <p className="text-gray-600">
              {t('classroomManagementDesc')}
            </p>
          </Card>
          <Card className="p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-2">{t('realTimeAnalytics')}</h3>
            <p className="text-gray-600">
          ...
          <Card className="p-6 hover:shadow-lg transition-shadow">
            ...
            <h3 className="text-xl font-semibold mb-2">{t('integratedCommunication')}</h3>
            <p className="text-gray-600">
              {t('integratedCommunicationDesc')}
            </p>
          </Card>
        </motion.div>
...
function Dashboard({ user }: { user: User }) {
  ...
  const greeting = currentTime.getHours() < 12 ? t("goodMorning") :
    currentTime.getHours() < 18 ? t("goodAfternoon") : t("goodEvening");
